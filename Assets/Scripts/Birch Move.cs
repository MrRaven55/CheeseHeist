...
public class BirchMove : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        GameObject birchUIElement = GameObject.FindGameObjectWithTag("Birch");
        endPoint = birchUIElement.GetComponent<RectTransform>();
    }
