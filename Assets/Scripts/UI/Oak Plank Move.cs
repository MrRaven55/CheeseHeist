...
public class OakPlankMove : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        GameObject OakPlankUIElement = GameObject.FindGameObjectWithTag("OakPlank");
        endPoint = OakPlankUIElement.GetComponent<RectTransform>();
